...
export interface MotherAndChildLineProps {
  size?: number | string;
  color?: string;
  className?: string;
...
export const MotherAndChildLine: React.FC<MotherAndChildLineProps> = ({
  size = 24,
  color = 'currentColor',
  className,
  style,
