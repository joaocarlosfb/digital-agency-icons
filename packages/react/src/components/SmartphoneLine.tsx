...
export interface SmartphoneLineProps {
  size?: number | string;
  color?: string;
  className?: string;
...
export const SmartphoneLine: React.FC<SmartphoneLineProps> = ({
  size = 24,
  color = 'currentColor',
  className,
  style,
