...
export interface InformationFillProps {
  size?: number | string;
  color?: string;
  className?: string;
...
export const InformationFill: React.FC<InformationFillProps> = ({
  size = 24,
  color = 'currentColor',
  className,
  style,
