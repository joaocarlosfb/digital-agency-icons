...
export interface SpecialistLineProps {
  size?: number | string;
  color?: string;
  className?: string;
...
export const SpecialistLine: React.FC<SpecialistLineProps> = ({
  size = 24,
  color = 'currentColor',
  className,
  style,
