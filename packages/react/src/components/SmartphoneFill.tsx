...
export interface SmartphoneFillProps {
  size?: number | string;
  color?: string;
  className?: string;
...
export const SmartphoneFill: React.FC<SmartphoneFillProps> = ({
  size = 24,
  color = 'currentColor',
  className,
  style,
