...
export interface FamilyLineProps {
  size?: number | string;
  color?: string;
  class?: string;
  style?: StyleValue;
...
const props = withDefaults(defineProps<FamilyLineProps>(), {
  size: 24,
  color: 'currentColor',
});
