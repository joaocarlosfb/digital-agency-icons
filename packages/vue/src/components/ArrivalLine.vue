...
export interface ArrivalLineProps {
  size?: number | string;
  color?: string;
  class?: string;
  style?: StyleValue;
...
const props = withDefaults(defineProps<ArrivalLineProps>(), {
  size: 24,
  color: 'currentColor',
});
