...
export interface MedicineFillProps {
  size?: number | string;
  color?: string;
  class?: string;
  style?: StyleValue;
...
const props = withDefaults(defineProps<MedicineFillProps>(), {
  size: 24,
  color: 'currentColor',
});
