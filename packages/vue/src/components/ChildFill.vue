...
export interface ChildFillProps {
  size?: number | string;
  color?: string;
  class?: string;
  style?: StyleValue;
...
const props = withDefaults(defineProps<ChildFillProps>(), {
  size: 24,
  color: 'currentColor',
});
