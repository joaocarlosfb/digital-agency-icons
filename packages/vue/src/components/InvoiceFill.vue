...
export interface InvoiceFillProps {
  size?: number | string;
  color?: string;
  class?: string;
  style?: StyleValue;
...
const props = withDefaults(defineProps<InvoiceFillProps>(), {
  size: 24,
  color: 'currentColor',
});
