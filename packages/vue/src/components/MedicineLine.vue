...
export interface MedicineLineProps {
  size?: number | string;
  color?: string;
  class?: string;
  style?: StyleValue;
...
const props = withDefaults(defineProps<MedicineLineProps>(), {
  size: 24,
  color: 'currentColor',
});
