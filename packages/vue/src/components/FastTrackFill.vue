...
export interface FastTrackFillProps {
  size?: number | string;
  color?: string;
  class?: string;
  style?: StyleValue;
...
const props = withDefaults(defineProps<FastTrackFillProps>(), {
  size: 24,
  color: 'currentColor',
});
