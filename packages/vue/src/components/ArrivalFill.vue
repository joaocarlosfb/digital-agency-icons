...
export interface ArrivalFillProps {
  size?: number | string;
  color?: string;
  class?: string;
  style?: StyleValue;
...
const props = withDefaults(defineProps<ArrivalFillProps>(), {
  size: 24,
  color: 'currentColor',
});
