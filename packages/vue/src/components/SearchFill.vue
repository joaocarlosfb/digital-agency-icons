...
export interface SearchFillProps {
  size?: number | string;
  color?: string;
  class?: string;
  style?: StyleValue;
...
const props = withDefaults(defineProps<SearchFillProps>(), {
  size: 24,
  color: 'currentColor',
});
